...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    { icon: Phone, title: "Call Us", details: ["+234 902 745 8826"] },
              ...
              <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 shadow-lg border border-slate-100">
                <div className="grid sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input type="tel" id="contact-phone" name="phone" className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="+234 902 745 8826" />
                  </div>
                  <div>
